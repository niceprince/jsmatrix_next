      ...
      >
        <div className="container mx-auto">
          <div className="flex flex-wrap">
            <div className="w-full px-2 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  ...
                  <a
                    href="https://www.instagram.com/jsmatrix.in/"
                    target="_blank"
                    aria-label="social-link"
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  >
                  ...
                  <Link
                    href="https://www.youtube.com/@jsmatrix-in"
                    target="_blank"
                    aria-label="social-link"
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  >
                  ...
                  <Link
                    href="https://www.linkedin.com/in/jsmatrix-in"
                    target="_blank"
                    aria-label="social-link"
            ...
            <div className="w-1/2 px-2 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-3/12">
            ...
            <div className="w-1/2 px-2 md:w-1/2 lg:w-3/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">
                  Support & Help
                </h2>
            ...
            <div className="hidden md:block w-1/2 px-2 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">
                  Terms
                </h2>
